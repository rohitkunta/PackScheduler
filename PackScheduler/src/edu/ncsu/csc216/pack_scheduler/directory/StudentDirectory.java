 ...
 * a unique id.
 * allows users to get, add, edit, or remove students from the directory
 * also can load or save a student directory
 * 
...
public class StudentDirectory {
	 ...
	 * 
	 * @throws IllegalArgumentException if unable to write to the output file
	 *                                  specified
	 */
	...
	/**
	 * Finds student object from given id
	 * @param id id field associated with a specific student
	 * @return the specific student if id matches, otherwise return null
	 */
