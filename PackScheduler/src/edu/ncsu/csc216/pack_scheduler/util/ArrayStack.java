 ...
 * 
 * @param <E> the element type being used in the ArrayStack
 */
public class ArrayStack<E> implements Stack<E> {

	/** Stores the capacity of the stack */
	...
	/**
	 * Constructor for the ArrayStack Initializes capacity to
	 * 
	...
	public void push(E element) {
		...
		if (list.size() == capacity) {
			throw new IllegalArgumentException("Stack capacity reached");
		}
		list.add(element);
		size++; 
	}
