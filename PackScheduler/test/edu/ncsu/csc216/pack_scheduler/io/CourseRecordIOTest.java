...
public class CourseRecordIOTest {
	...
	public void testWriteCourseRecords() {
		...
		courses.add(new Course("CSC116", "Intro to Programming - Java", "001", 3, "jdyoung2", 100, "MW", 910, 1100));
		courses.add(new Course("CSC116", "Intro to Programming - Java", "002", 3, "spbalik", 100, "MW", 1120, 1310));
		courses.add(new Course("CSC116", "Intro to Programming - Java", "003", 3, "tbdimitr", 100, "TH", 1120, 1310));
		courses.add(new Course("CSC216", "Software Development Fundamentals", "001", 3, "sesmith5", 100, "TH", 1330, 1445));
		courses.add(new Course("CSC216", "Software Development Fundamentals", "002", 3, "ixdoming", 50, "MW", 1330, 1445));
		courses.add(new Course("CSC216", "Software Development Fundamentals", "601", 3, "jctetter", 75, "A"));
		courses.add(new Course("CSC217", "Software Development Fundamentals Lab", "202", 1, "sesmith5", 80, "M", 1040, 1230));
		courses.add(new Course("CSC217", "Software Development Fundamentals Lab", "211", 1, "sesmith5", 65, "T", 830, 1020));
		courses.add(new Course("CSC217", "Software Development Fundamentals Lab", "223", 1, "sesmith5", 100, "W", 1500, 1650));
		courses.add(new Course("CSC217", "Software Development Fundamentals Lab", "601", 1, "sesmith5", 90, "A"));
		courses.add(new Course("CSC226", "Discrete Mathematics for Computer Scientists", "001", 3, "tmbarnes", 100, "MWF", 935, 1025));
		courses.add(new Course("CSC230", "C and Software Tools", "001", 3, "dbsturgi", 115, "MW", 1145, 1300));
		courses.add(new Course("CSC316", "Data Structures and Algorithms", "001", 3, "jtking", 95, "MW", 830, 945));
